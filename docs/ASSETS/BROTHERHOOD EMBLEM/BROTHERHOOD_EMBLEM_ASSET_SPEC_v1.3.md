...
El archivo maestro deberá conservarse siempre en un formato sin compresión con pérdida.

No podrá utilizarse un archivo JPG ni ningún otro formato con pérdida como origen para generar nuevas variantes oficiales.
...
```
BROTHERHOOD_EMBLEM_PIPGREENDIM
```
...
| 1.3 | Aprobada | Se incorporan Asset ID individuales para cada variante oficial y se establece la prohibición de utilizar formatos con compresión con pérdida como origen de nuevas variantes del recurso maestro. |
