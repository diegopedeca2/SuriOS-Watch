...
Primera versión del documento operativo correspondiente al Sprint 005.

Este Sprint constituye el Sprint actualmente autorizado del proyecto y su estado operativo queda registrado en:
...
- integración como elemento de fondo de la watchface;
...
La implementación debería afectar únicamente a los recursos estrictamente necesarios para incorporar el emblema.

No deberán modificarse componentes ajenos al alcance del Sprint.
...
Una vez completado este Sprint, el siguiente Sprint previsto será:

**Sprint 006 — Integración de Spotify y Google Wallet.**

Sprint 006 no deberá iniciarse hasta el cierre técnico y documental de Sprint 005.
