...
Versión 1.1 del documento operativo correspondiente al Sprint 005.
...
- [ASSET_REPOSITORY v1.0](../ASSETS/ASSET_REPOSITORY_v1.0.md)
...
Como referencia inicial, se espera modificar únicamente:

- `watch/watchface/src/main/res/raw/watchface.xml`

utilizando el recurso gráfico oficial definido en:

- `assets/brotherhood-emblem/`
